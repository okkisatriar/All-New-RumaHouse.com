...
class Product_detail extends Component {
  ...
  componentDidMount=() =>
  {
    ...
    axios.get('http://localhost:8002/produkdetail/' + id_produk).then((getData) => 
    {
      ...
      var foto_produk2 = getData.data[0].foto_produk2;
      var foto_produk3 = getData.data[0].foto_produk3;
            ...
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
              ...
              <div className="carousel-inner">
                ...
                <div className="carousel-item">
                  <img className="d-block w-100" src={'http://localhost:8002/tampungfile/'+this.state.foto_produk2} alt="Second slide" />
                </div>
                <div className="carousel-item">
                  <img className="d-block w-100" src={'http://localhost:8002/tampungfile/'+this.state.foto_produk3} alt="Third slide" />
                </div>
              </div>
                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-md-2">
                      <img style={{height: 35, width: 37, borderRadius: '50%'}} className="card-img" src={'http://localhost:8002/tampungfile/'+ this.state.foto_profile} alt="Card image cap" />
                    </div>
                    <div className="col-md-10">
                      <h2>{this.state.namadepan}</h2>
                      <h5>{this.state.handphone}</h5>
                      <Link to ={{pathname:'/Profile_lain/', state:{id_username:this.state.id_username}}}>Lihat Iklan lainnya</Link>
                    </div>
                  </div>
                  <div className="col-md-12" style={{marginTop: 30}}>
                    <div className="pull-right">
                          <button onClick={()=>this.buy(this.state.id,this.state.harga)} className="btn btn-primary text-right">WISHLIST</button>
                    </div>
                  </div>
