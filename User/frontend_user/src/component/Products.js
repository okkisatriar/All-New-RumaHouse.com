  ...
  Filter = (cat) =>
    {
        ...
        if (filtercat !== 0)
        {
          axios.post('http://localhost:8002/FilterProduk', 
          {
              filterCat: filtercat
          })
          .then((getData) => 
            ...
            <div className="col-md-12">
              <div className="row">
                <div className="col-md-3">
                  ...
                  <a onClick={() => this.Filter(0)} className="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" role="tab" aria-controls="fasilitas">Semua Produk</a>
                  <a onClick={() => this.Filter(2)} className="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" role="tab" aria-controls="spesifikasi">Apartemen</a>
                  <a onClick={() => this.Filter(1)} className="list-group-item list-group-item-action" id="list-home-list" data-toggle="list" role="tab" aria-controls="fasilitas">Rumah</a>
                    {/* <span className="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="spesifikasi">Apartemen</a>
                    <span className="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab" aria-controls="fasilitas">Rumah</a> */}
                  </div>
                </div>
