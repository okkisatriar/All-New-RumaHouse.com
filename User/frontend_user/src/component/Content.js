    ...
    return (
      <div>
            ...
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img className="d-block w-100" src={'http://localhost:8002/tampungfile/'+ "Depan.jpg"} alt="Card image cap" />
                </div>
                <div className="carousel-item">
                  <img className="d-block w-100" src={'http://localhost:8002/tampungfile/'+ "Depan2.jpg"} alt="Card image cap" />
                </div>
                <div className="carousel-item">
                  <img className="d-block w-100" src={'http://localhost:8002/tampungfile/'+ "Depan3.jpg"} alt="Card image cap" />
                </div>
              </div>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12" style={{textAlign: 'center', marginTop: 30}}>
